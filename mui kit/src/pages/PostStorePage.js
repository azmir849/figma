            ...
            <Stack spacing={3}>
              ...
              <Accordion expanded={expanded === 'panel2'} onChange={handleChangeAccordian('panel2')}>
                <AccordionSummary aria-controls="panel2d-content" id="panel2d-header">
                  <Typography>#2 Title, Featurd Image & Description</Typography>
                </AccordionSummary>
                <AccordionDetails>
                  <Grid container spacing={3}>
                    <Grid item xs={12} md={12}>
                      <Card sx={{ p: 3 }}>
                        <Stack spacing={3}>
                          ...
                          <TextField name="slug" label="Slug"  value={values.slug}/>
                          <Box sx={{ mt: 2 }}>
                            <SunEditor
                              id="details"
                              name="description"
                ...
                <AccordionSummary aria-controls="panel3d-content" id="panel3d-header">
                  <Typography>#3 ScreenShots</Typography>
                </AccordionSummary>
                <AccordionDetails>
                   {/* secreenshot -1 */}
                ...
                <Accordion expanded={expanded === 'panel4'} onChange={handleChangeAccordian('panel4')}>
                  <AccordionSummary aria-controls="panel3d-content" id="panel3d-header">
                    <Typography>#4 File Url, Preview Url, Gif File & Reading Time</Typography>
                  </AccordionSummary>
                  <AccordionDetails>
                      <Grid container spacing={1}>
                        <Grid item xs={12} md={12}>
                ...
                <Accordion expanded={expanded === 'panel5'} onChange={handleChangeAccordian('panel5')}>
                  <AccordionSummary aria-controls="panel3d-content" id="panel3d-header">
                    <Typography>#5 Author & Backlink</Typography>
                  </AccordionSummary>
                  <AccordionDetails>
                      <Grid container spacing={1}>
                        <Grid item xs={12} md={12}>
